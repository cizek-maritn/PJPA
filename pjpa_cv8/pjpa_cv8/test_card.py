...
#"""
#Testy pro modul card a tøídu Card ze cvièení 8.

#Ke spuštìní je potøeba modul pytest
...
def test_bad_card_raises(rank, suit):
    #"""
    #Pokud karta vytvoøit nejde - napøíklad proto, e je špatná barva èi hodnota,
    #musí tøída vyhodit vıjimku TypeError.
    #"""
...
def test_greater_then():
    #"""
    #Test porovnani, prvni karta je vìtší ne druhá
    #"""
...
def test_less_then():
    #"""
    #Test porovnání, první karta je menší ne druhá
    #"""
    t_card1 = card.Card(2, "s")
